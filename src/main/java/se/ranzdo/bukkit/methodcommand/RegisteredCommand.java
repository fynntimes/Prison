...
public class RegisteredCommand {
    ...
    RegisteredCommand(String label, CommandManager handler, RegisteredCommand parent) {
        this.label = label;
    ...
    void set(Object methodInstance, Method method) {
        ...
        if (methodParameters.length == 0 ?
            true :
            !CommandSender.class.isAssignableFrom(methodParameters[0])) {
            throw new RegisterCommandMethodException(method,
        ...
        for (int i = 1; i < methodParameters.length; i++) {
            ...
            if (commandArgAnnotation == null && flagArgAnnotation == null) {
                throw new RegisterCommandMethodException(method,
                    "The command annonation is present on a method, however one of the parameters is not annotated.");
            }
            ...
            if (flagArgAnnotation != null) {
                ...
                if (flag == null) {
                    throw new RegisterCommandMethodException(method,
                        "The flag annonation is present on a parameter, however the flag is not defined in the flags annonation.");
                }
            }
            ...
            if (commandArgAnnotation == null) {
                if (argumentClass != boolean.class && argumentClass != Boolean.class) {
                    throw new RegisterCommandMethodException(method,
                        "The flag annonation is present on a parameter without the arg annonation, however the parameter type is not an boolean.");
                }
